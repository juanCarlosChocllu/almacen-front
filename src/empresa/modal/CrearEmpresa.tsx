...
export const CrearEmpresa = ({setCargarData, cargarData }:{setCargarData:(data:boolean)=> void, cargarData:boolean} ) => {
  const {token}=useContext(AutenticacionContext)
  const { register, handleSubmit, setValue } = useForm<formEmpresaI>();
