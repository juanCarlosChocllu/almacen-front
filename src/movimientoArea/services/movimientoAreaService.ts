...
export const listarStockPorCodigo = async ( token:string, id:string): Promise<MovimientoAreaI[]> => {
  try {       
  
    const response = await instance.get(`movimiento/area/informacion/stock/${id}`,{
