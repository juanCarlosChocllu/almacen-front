...
export const SelectProveedorEmpresa = ({ proveedor, eliminarProveedor }: { proveedor: proveedorEmpresaI, eliminarProveedor: () => void }) => {
  return (
      ...
      <table className="min-w-full table-auto text-left text-sm">
        ...
        <tbody>
          <tr key={proveedor._id} className="bg-white hover:bg-gray-100 transition-colors">
            <td className="px-2 py-1">{proveedor.nombre}</td>
