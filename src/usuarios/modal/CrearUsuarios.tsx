...
import { listarRol, listarRolPublicas } from "../../rol/services/rolService";
...
export const CrearUsuarios = ({ recargar, setRecargar }: RecargarDataI) => {
  ...
  const { register, handleSubmit, reset, watch } = useForm<FormUsuariosI>();
